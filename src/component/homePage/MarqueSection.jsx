...
const MarqueSection = () => {
    return (
        <div className='container flex justify-between items-center mx-auto gap-4 px-2 py-4 bg-linear-to-r from-[#384959] to-[#88BDF2] text-white my-15'>
            <button className='btn bg-linear-to-r from-[#384959] to-[#88BDF2] text-white'>Latest News</button>
            <Marquee pauseOnHover={true} speed={90} className="">
                {
